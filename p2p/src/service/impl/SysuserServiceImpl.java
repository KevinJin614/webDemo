...
public class SysuserServiceImpl implements SysuserService{
	...
	@Override
	public void modSysuserPassword(String oldPassword, Sysuser sysuser)
			throws FaultNameOrPasswordException {
		
		Sysuser oldSysuser = sd.selectById(sysuser.getId());
		
		if(!oldPassword.equals(oldSysuser.getLoginPassword())){
			throw new FaultNameOrPasswordException("密码错误");
		}
