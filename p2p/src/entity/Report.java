...
public class Report implements java.io.Serializable {
	...
	*/
	...
	private Integer financingInReturnNumTotal;
	...
	public Report(Company company, Integer productNum, Integer financingTarget,
			Integer financingActualTotal, Integer financingInReturnNumTotal) {
		super();
	...
	public Integer getFinancingInReturnNumTotal() {
		return financingInReturnNumTotal;
	}


	public void setFinancingInReturnNumTotal(Integer financingInReturnNumTotal) {
		this.financingInReturnNumTotal = financingInReturnNumTotal;
	}
