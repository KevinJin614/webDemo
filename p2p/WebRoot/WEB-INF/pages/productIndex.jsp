...
<%--		    TODO:productIndex银行的介绍图片获取位置没定义            --%>
		                	<div class="fl"><img src="${pageContext.request.contextPath }/images/logo.png" />经理：${product.linkMan }<br />${product.ownedBank }</div>
		                    <div class="fr">
		...
		<div class="modal fade" style="margin-top: 200px;" id="applyModal" tabindex="-1" role="dialog" aria-labelledby="applyModal" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content">
		        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/apply/applyProduct.action?productId=${product.productId }">
				      ...
				      <div class="modal-body">
					              ...
					              <div class="col-lg-10">
					                <input type="text" class="form-control" id="productId" name="apply.applyId"  readonly="readonly" value="11"/>
					              </div>
					            </div>
					            <div class="form-group">
					              <label for="productName" class="col-lg-2 control-label">产品名称</label>
					              <div class="col-lg-10">
					                <input type="text" class="form-control" id="productName" name="apply.product.productName" readonly="readonly" value="银投联贷" />
					              </div>
					            </div>
					            <div class="form-group">
