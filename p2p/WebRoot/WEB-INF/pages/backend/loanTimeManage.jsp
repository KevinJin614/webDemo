									...
									<td>
										...
										<c:if test="${lendingPeriod.status=='O'}">
											<a class="btn btn-primary btn-xs btn-danger"
												href="${pageContext.request.contextPath }/lendingPeriod/modLendingPeriodStatus?lendingPeriodId=${lendingPeriod.lendingPeriodId}&status=C">
												禁用 
										...
										<c:if test="${lendingPeriod.status=='C'}">
											<a class="btn btn-primary btn-xs btn-success"
												href="${pageContext.request.contextPath }/lendingPeriod/modLendingPeriodStatus?lendingPeriodId=${lendingPeriod.lendingPeriodId}&status=O">
												启用 
		...
		<div class="modal fade" style="margin-top: 200px;" id="proModify"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/lendingPeriod/modLendingPeriodPeriod.action">
