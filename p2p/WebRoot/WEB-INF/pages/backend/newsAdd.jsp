	...
	<body style="padding: 5px 10px">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" enctype="multipart/form-data" action="${pageContext.request.contextPath }/news/newsAdd.action">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							...
							<div id="content" style="overflow: scroll; max-height: 300px; border: 1px solid; height: 1400px;">abc</div>
